...
public class Window extends JPanel {
	...
	public Window() {
		...
		negatives[0] = new JButton("-/+");
		negatives[0].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (clicked) {
					if (!numberfieldOne.getText().isEmpty()) {
						try {
							numberfieldOne.setText(Double.toString((-1) * (Double.parseDouble(numberfieldOne.getText()))));
		...
		negatives[1] = new JButton("-/+");
		negatives[1].addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (clicked) {
					if (!numberfieldTwo.getText().isEmpty()) {
						try {
							numberfieldTwo.setText(Double.toString((-1) * (Double.parseDouble(numberfieldTwo.getText()))));
						} catch (NumberFormatException e) {
							System.err.println("Only numbers allowed!");
							e.printStackTrace();
							if (!outputfield.getText().isEmpty()) {
	...
	private static class AddAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				} else if (b.equals("Ans") || b.equals("ans")) {
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				if (a.equals("Ans") || a.equals("ans")) {
					...
					var = Math.pow(Double.parseDouble(numberfieldOne.getText()),
							Double.parseDouble(numberfieldTwo.getText()));
				}
				outputfield.setText(Double.toString(var));
				ans = var;
				System.out.println(var);
				...
				if (!b.equals("ans") && !b.equals("Ans")) {
					if (Double.parseDouble(b) == 0) {
						...
						if (a.equals("Ans") || a.equals("ans")) {
							...
							number = Double.parseDouble(numberfieldOne.getText())
									/ Double.parseDouble(numberfieldTwo.getText());
						}
					}
				} else {
